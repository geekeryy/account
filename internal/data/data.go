...
type AccountRepo interface {
	...
	GetByMobile(ctx context.Context, user *UserModel) error
	GetByEmail(ctx context.Context, user *UserModel) error
	GetByAccount(ctx context.Context, account string) (*UserModel, error)
}
